...
{
    /// <summary>
    /// Our web server. Not used by pages hosted in ASP.NET.
    ...
    /// </summary>
    public class WebServer : GenericServer, IWebServerUtilities
    {
        ...
        public void Add(IWebSiteExecutor site, string hostName)
        {
